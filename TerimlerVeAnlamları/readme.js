...
btn.addEventListener("click", function(){
    ...
    `   
    <h1>Yazılım Dünyasında Kullanılan Terimler</h1>
    <ul type="square">
        <strong style="font-size: 3rem;">A</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">B</strong>
        <br><br>
        <li>Back= Geri</li>
        <hr>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">C</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">D</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">E</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">F</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">G</strong>
        <br><br>
        <li>Game= Oyun</li>
        <hr>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">H</strong>
        <br><br>
        <li>Halt= Durdurma</li>
        <hr>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">I</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">K</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">L</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">M</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">N</strong>
        <br><br>
        <li>Network= Ağ</li>
        <hr>
        ...
        <hr>
        <br>
        <strong style="font-size: 3rem;">O</strong>
        <br><br>
        <li>Object= Nesne</li>
        <hr>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">P</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">Q</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">R</strong>
        <br><br>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">S</strong>
        <br><br>
        <li>Save= Kaydet</li>
        <hr>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">T</strong>
        <br><br>
        <li>Tab= Sekme</li>
        <hr>
        <li>Target= Hedef</li>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">U</strong>
        <br><br>
        ...
        <hr>
        <br>
        <strong style="font-size: 3rem;">V</strong>
        <br><br>
        <li>Valid= Geçerli</li>
        <hr>
        ...
        <br>
        <br>
        <strong style="font-size: 3rem;">W</strong>
        <br><br>
        ...
        <hr>
        <br>
        <strong style="font-size: 3rem;">Z</strong>
        <br><br>
